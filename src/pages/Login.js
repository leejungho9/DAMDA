...
function Login() {
  ...
  return (
    <LoginWrapper>
      ...
      <KakaoBtn><img src="icons/kakao_logo.svg" />카카오 로그인</KakaoBtn>
      <NaverBtn onClick={handleNaverLogin}><img src="icons/naver_logo.png" width={18} height={16} />네이버 로그인</NaverBtn>
      <SigninBtn><span>회원가입 하기</span></SigninBtn>
    </LoginWrapper>
  )
}
